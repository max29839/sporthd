...
{
    /// <summary>
    /// Fake FootballSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeFootball_Football : IFootball_Football 
    {
        ...
        public ObservableCollection<Entities.FootballSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.FootballSchema> 
			{ 
			...
			return new ObservableCollection<Entities.FootballSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.FootballSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of FootballSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.FootballSchema>.FilterCollection(filter, GetData());
        }
