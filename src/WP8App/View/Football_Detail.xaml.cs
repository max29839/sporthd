...
{
    /// <summary>
    /// Phone application page for Football_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Football_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Football_Detail and all its components.
        /// </summary>
        public Football_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaFootball_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaFootball_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaFootball_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaFootball_Detail(PanoramaFootball_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaFootball_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IFootball_Football>();
				AddHomeAppBarButton();
				...
				((IViewModels.IFootball_DetailViewModel)DataContext).CurrentFootballSchema = pinnedItem;				
			}
		}
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.IFootball_ListViewModel>(); 
