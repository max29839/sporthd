...
namespace WPAppStudio.Services
{
    ...
    public class ViewModelLocatorService
    {
        ...
        /// <summary>
        /// Gets the reference to a Football_ListViewModel.
        /// </summary>
		public IViewModels.IFootball_ListViewModel Football_ListViewModel
        {
            get { return _container.Resolve<IViewModels.IFootball_ListViewModel>(); }
        }

        /// <summary>
        /// Gets the reference to a Football_DetailViewModel.
        /// </summary>
		public IViewModels.IFootball_DetailViewModel Football_DetailViewModel
        {
            get { return _container.Resolve<IViewModels.IFootball_DetailViewModel>(); }
        }
		/// <summary>
